...
def data_preprocessing(data_roots, abandon_stop_words):
    ...
    stop_words_list = []
    for tmp_file_name in os.listdir("/data1/dxy/codes/NLP_homework/NLP_homework3/stopwords/"):      # replace this path with the stopwords path
        with open("/data1/dxy/codes/NLP_homework/NLP_homework3/stopwords/"+tmp_file_name, "r", encoding="utf-8", errors="ignore") as f:
...
if __name__ == '__main__':
    ...
    data_roots = '/data1/dxy/codes/NLP_homework/NLP_homework1/txt_files/'  # replace this path with the txt files path
